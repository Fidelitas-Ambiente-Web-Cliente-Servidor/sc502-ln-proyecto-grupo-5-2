...
<body>
    ...
    <img src="img/logo.png" alt="Vida Fit" width="230">
        ...
        <nav>
            ...
            <a class="activo"><img src="../img/configuracion.png" alt="Configuración" width="30"> <b>Configuración</b></a>
        </nav>
            ...
            <div class="panel">
                ...
                <div class="campo-config">
                    ...
                    <div class="password-container">
                        ...
                        <span class="eye-icon" onclick="togglePass('passActual')">*</span>
                    </div>
                </div>
                ...
                <div class="campo-config">
                    ...
                    <div class="password-container">
                        ...
                        <span class="eye-icon" onclick="togglePass('passNueva')">*</span>
                    </div>
                </div>
                ...
                <div class="campo-config">
                    ...
                    <div class="password-container">
                        ...
                        <span class="eye-icon" onclick="togglePass('passConfirmar')">*</span>
                    </div>
                </div>
