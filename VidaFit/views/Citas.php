...
<body>
    ...
    <img src="../img/logo.png" alt="Vida Fit" width="230">
        ...
        <nav>
            ...
            <a class="activo"><img src="../img/citas.png" alt="Citas" width="30"> <b>Citas</b></a>
    ...
    <main class="contenido">
        ...
        <section class="cards-superiores">
            <div class="card">
                <div class="icono"><img src="../img/citas.png" alt="Citas" width="35"></div>
                <div>
                    <p>Próxima cita</p>
                    <h2>27 Jun</h2>
            ...
            <div class="card">
                <div class="icono naranja"><img src="../img/citas.png" alt="Citas" width="35"></div>
                <div>
            ...
            <div class="card">
                <div class="icono"><img src="../img/usuario.png" alt="Usuario" width="35"></div>
                <div>
                    <p>Profesionales</p>
                    <h2>2</h2>
